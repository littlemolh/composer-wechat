...
use WeChatPay\Builder as WeChatPayBuilder;
...
class  Builder
{
     ...
     * @return Builder
     */
    public function cert(string $public_path, string $private_path, string $platform_path = ''): Builder
    {
     ...
     * @return Builder
     */
    public function mchid(string $mchid, string $subMchid = ''): Builder
    {
        // 商户号
        self::$mchid = $mchid;
        // 子商户号
     ...
     * @return void
     */
    public function apiKey(string $apiKey): Builder
    {
        // API KEY
        self::$apiKey = $apiKey;
        return $this;
     ...
     * @return Builder
     */
    public function appid(string $appid, string $subAppid = ''): Builder
    {
        // APPID
        self::$appid = $appid;
